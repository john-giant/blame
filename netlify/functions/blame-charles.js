    ...
    exports.handler = async function(event, context) {
        ...
        try {
            const prompt = "Generate a random, well-known historical disaster (e.g., the sinking of the Titanic, the Great Fire of London, the eruption of Mount Vesuvius, the Black Death, the collapse of the Roman Empire, the Hindenburg disaster, the Chernobyl disaster, the invention of Nickelback) and then write a humorous, absurd, and completely unfounded explanation of how Charles Hoskinson was secretly responsible for it. Keep it concise, around 1-3 sentences."; // Prompt adjusted for shorter output
            const payload = {
